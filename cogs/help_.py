...
class Original_Help(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        get_category = f'{commands.cog.qualified_name}:' if commands.cog is not None else no_category
        ...
        for category, commands in to_iterate:
            commands = sorted(commands, key=lambda c: f'`{c.name}`') if self.sort_commands else list(commands)
